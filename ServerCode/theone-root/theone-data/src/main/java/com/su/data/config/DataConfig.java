...
public class DataConfig {
	...
	@Bean
	public RmiServiceExporter rmiServiceExporter(IDataRmiService dataRmiService) {
		RmiServiceExporter exporter = new RmiServiceExporter();
		exporter.setServiceName(rmiName);
		exporter.setServiceInterface(IDataRmiService.class);
