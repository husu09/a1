...
public class CustomerWorker {
	...
	public void doWork(String message) {
		MQMessage mqMessage = JSONUtil.dataDecode(message, MQMessage.class);
		try {
			Object object = JSONUtil.dataDecode(mqMessage.getData(), Class.forName(mqMessage.getClassName()));
